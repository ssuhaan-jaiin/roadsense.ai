...
function IconGlobe({ className }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.65" aria-hidden>
      <circle cx="12" cy="12" r="10" strokeLinecap="round" />
      <path d="M2 12h20M12 2a14 14 0 000 20M12 2a14 14 0 010 20" strokeLinecap="round" />
    </svg>
  )
}
  ...
  return (
    <footer className="site-footer">
      <div className="site-footer-inner">
        ...
        <p className="site-footer-note">roadsense.ai · exploratory road safety visuals</p>
      </div>
    </footer>
  )
}
